...
import capacitorImage from '../assets/Capacitor.png';
import capacitorVideo from '../assets/Capacitor_video.mp4';

// CONFIGURATION: strict 4-second delay for the reveal
...
const HeroSection = () => {
    ...
    const playRevealSequence = () => {
        ...
        // Phase 1: Darken Background Video
        ...
        // Phase 2: Show Content Container
        ...
        <section ref={heroRef} className="relative w-full h-screen overflow-hidden bg-bg-void flex items-center justify-center">
            ...
            <div className="absolute inset-0 w-full h-full z-0 pointer-events-none">
                <video
                    ...
                    muted
                    playsInline
                    className="w-full h-full object-cover transition-all duration-[1500ms] ease-in-out will-change-filter"
                />
            ...
            >
                ...
                <div className="lg:col-span-7 flex flex-col justify-center text-left">
                    <div className="flex items-center gap-3 mb-6">
                        <div className={`h-[1px] w-8 bg-cyan-neon/60 transition-all duration-1000 ${showUI ? 'w-8 opacity-100' : 'w-0 opacity-0'}`}></div>
                        <span className={`text-cyan-neon/80 font-mono text-[10px] tracking-[0.3em] uppercase transition-opacity duration-1000 ${showUI ? 'opacity-100' : 'opacity-0'}`}>
                            System Online
                        </span>
                    </div>
